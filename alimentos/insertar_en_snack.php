...
if(odbc_fetch_row($resultado)) {
    ...
    $sql_insert = "INSERT INTO snack (id_usuario, alimento_id, alimento_s, cantidad_s, unidad_s, calorias_s, proteinas_s, carbohidratos_s, grasas_s) VALUES ($id_usuario, $alimento_id, '$nombre_alimento', $cantidad_total, '$unidad', $calorias, $proteinas, $carbohidratos, $grasas)";
