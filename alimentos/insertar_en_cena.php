...
if(odbc_fetch_row($resultado)) {
    ...
    $sql_insert = "INSERT INTO cena (id_usuario, alimento_id, alimento_cna, cantidad_cna, unidad_cna, calorias_cna, proteinas_cna, carbohidratos_cna, grasas_cna) VALUES ($id_usuario, $alimento_id, '$nombre_alimento', $cantidad_total, '$unidad', $calorias, $proteinas, $carbohidratos, $grasas)";
